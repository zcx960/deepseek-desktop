...
// Kept local on purpose: sharing a module with another preload entry makes the
// bundler emit a chunk, and a sandboxed preload cannot require one.
function isDesktopColorScheme(value: unknown): value is 'light' | 'dark' {
