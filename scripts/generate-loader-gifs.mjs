...
// square "bubbles" — the same motion the previous hand-drawn loaders used, so
// splash.html needs no changes.
...
/** Native viewBox of the official DeepSeek mark carried by brand-mark.svg. */
