...
describe('GitHub release contract', () => {
  ...
  it('routes releases through GitHub and credits the upstream project', async () => {
    ...
    for (const readme of readmes) {
      ...
      // This build is a secondary development of the upstream desktop shell, so
      // every README has to say where it came from.
      expect(readme).toContain('dataelement/dsh-desktop')
